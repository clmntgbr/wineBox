...
REDIPS.drag = function () {
    var s, A, M, Da, Sa, Ta, fa, ga, ma, Ea, Fa, W, na, Ga, $, oa, aa, Ha, B, w, N, pa, qa, ra, Ia, sa, Ja, H, t, Ka, Ua, ta, La, ha, ia, ua, Va, Wa, Ma, Na, va, wa, xa, ja, Oa, Xa, ba, Ya, p = null, Za = /\bredips-drag\b/i, J = 0, K = 0, ya = null, za = null, O = [], u = null, P = 0, Q = 0, S = 0, T = 0, U = 0, V = 0, ca, g = [], da, Aa, q, L = [], n = [], y = null, F = null, X = 0, Y = 0, $a = 0, ab = 0, ka = !1, Pa = !1, ea = !1, Ba = [], Ca, I, h = null, x = null, C = null, j = null, z = null, R = null, l = null, D = null, Z = null, i = !1, m = !1, v = "cell", la = {div: {}, divClass: {}, cname: "redips-only", other: "deny"}, Qa = {
        action: "deny", cname: "redips-mark",
        exception: {}, exceptionClass: {}
    }, k = {}, bb = {keyDiv: !1, keyRow: !1, sendBack: !1, drop: !1};
    M = function () {
        return !1
    };
    s = function (a) {
        ...
        for (c = a = 0; a < e.length; a++) if (!("redips_clone" === e[a].parentNode.id || -1 < e[a].className.indexOf("redips-nolayout"))) {
            b = e[a].parentNode;
            d = 0;
            ...
            b = 0;
            for (f = !1; b < d.length; b++) if (1 < d[b].rowSpan) {
                f = !0;
                break
            }
        ...
        a = 0;
        for (e = da = 1; a < g.length; a++) if (0 === g[a].redips.nestedLevel) {
    ...
    Da = function (a) {
        ...
        n = B(k.current, b);
        -1 === i.className.indexOf("row") ? (REDIPS.drag.mode = v = "cell", REDIPS.drag.event.clicked(k.current)) :
    ...
    ja = function (a, c) {
        ...
        e = b.rows.length - 1;
        f = "animated" === c ? 0 === e : !0;
        for (o = e; 0 <= o; o--) if (o !== d.rowIndex) {
            if (!0 === f && void 0 === c) {
                e = b.rows[o];
                for (g = 0; g < e.cells.length; g++) if (-1 < e.cells[g].className.indexOf("redips-rowhandler")) {
                    f = !1;
                    break
                }
            }
    ...
    Xa = function (a, c) {
        ...
        for (b = 0; b < f.length; b++) for (d = 0; d < f[b].length; d++) switch (e = f[b][d].type, e) {
            case "text":
            case "textarea":
            case "password":
    ...
    fa = function (a) {
        var c = a || window.event, b, d, e, a = c.clientX;
        e = c.clientY;
        U = V = 0;
        ...
        if (q && "cell" === v && (null === h || null === j || null === l)) i.parentNode.removeChild(i),
            L[m.id] -= 1, REDIPS.drag.event.notCloned(); else if (null === h || null === j || null === l) REDIPS.drag.event.notMoved(); else {
            ...
            } else Oa(b, d); else REDIPS.drag.event.rowNotMoved(); else if (!q && !ka) REDIPS.drag.event.notMoved(); else if (q && C === h && R === j && Z === l) i.parentNode.removeChild(i), L[m.id] -= 1, REDIPS.drag.event.notCloned(); else if (q && !1 === REDIPS.drag.clone.drop && (a < c.redips.offset[3] || a > c.redips.offset[1] ||
                e < c.redips.offset[0] || e > c.redips.offset[2])) i.parentNode.removeChild(i), L[m.id] -= 1, REDIPS.drag.event.notCloned(); else if (-1 < k.target.className.indexOf(REDIPS.drag.trash.className)) i.parentNode.removeChild(i), REDIPS.drag.trash.question ? setTimeout(function () {
                if (confirm(REDIPS.drag.trash.question)) Ea(); else {
                    if (!q) {
            ...
            }, 20) : Ea(); else if ("switch" === REDIPS.drag.dropMode) if (a = REDIPS.drag.event.droppedBefore(k.target), !1 === a) ma(!1); else {
                i.parentNode.removeChild(i);
    ...
    ma = function (a) {
        ...
        if (!1 !== a) {
            if (!0 === bb.sendBack) {
                ...
                for (b = 0; b < a.length; b++) if (i !== a[b] && 0 === i.id.indexOf(a[b].id)) {
                    c = a[b];
                    break
                }
                if (c) {
    ...
    ga = function (a) {
        var a = a || window.event, c = REDIPS.drag.scroll.bound, b, d, e, f;
        a.touches ? (d = X = a.touches[0].clientX, e = Y = a.touches[0].clientY) : (d = X = a.clientX, e = Y = a.clientY);
        b = Math.abs($a - d);
        f = Math.abs(ab - e);
        if (!Aa) {
            if ("cell" === v && (ea || !0 === REDIPS.drag.clone.keyDiv && Pa)) REDIPS.drag.objOld = m = i, REDIPS.drag.obj = i = ra(i, !0), q = !0, REDIPS.drag.event.cloned(); else {
                if ("row" === v) {
        ...
        if (REDIPS.drag.scroll.enable) {
            ...
            for (f = 0; f < O.length; f++) if (b = O[f], b.autoscroll && d < b.offset[1] && d > b.offset[3] && e < b.offset[2] && e > b.offset[0]) {
                S = c - (b.midstX >
    ...
    Ga = function () {
        if ("number" === typeof window.innerWidth) J = window.innerWidth, K = window.innerHeight; else if (document.documentElement && (document.documentElement.clientWidth || document.documentElement.clientHeight)) J = document.documentElement.clientWidth,
            K = document.documentElement.clientHeight; else if (document.body && (document.body.clientWidth || document.body.clientHeight)) J = document.body.clientWidth, K = document.body.clientHeight;
        ya = document.documentElement.scrollWidth;
        za = document.documentElement.scrollHeight;
        w()
    };
    $ = function () {
        ...
        c = function (a, b, c) {
            var d = null, e;
            for (e in c) if (-1 < a.indexOf(e) && (d = !1, -1 < b.indexOf(c[e]))) {
                d = !0;
                break
            }
            return d
        ...
        for (h = 0; h < g.length; h++) if (!1 !==
            ...
            for (j = 0; j < d.length - 1; j++) if (void 0 !== d[j]) {
                n[0] = d[j][0];
                if (void 0 !== d[j + 1]) n[2] =
                    d[j + 1][0]; else for (f = j + 2; f < d.length; f++) if (void 0 !== d[f]) {
                    n[2] = d[f][0];
                    break
                }
                if (r <= n[2]) break
            ...
            do for (l = b = g[h].rows[j].cells.length - 1; 0 <= l; l--) if (b = g[h].rows[j].cells[l], n[3] = d[j][3] + b.offsetLeft, n[1] = n[3] + b.offsetWidth, e = n[0] + (b.offsetTop - g[h].rows[j].offsetTop), n[3] <= o && o <= n[1] && e <= r && r <= e + b.offsetHeight) {
                n[0] = e;
            ...
            if (-1 === b.className.indexOf(REDIPS.drag.trash.className)) if (o = c(i.className, b.className, la.divClass), -1 < b.className.indexOf(REDIPS.drag.only.cname)) {
            ...
            !1 === o && "allow" === REDIPS.drag.mark.action) if (o = c(i.className, b.className, Qa.exceptionClass), -1 === b.className.indexOf(Qa.exception[i.id]) && !0 !== o) {
                a();
                break
            }
            ...
            if ("cell" === v) {
                if (("single" === REDIPS.drag.dropMode || c) && 0 < b.childNodes.length) {
                    ...
                    c = !0;
                    for (f = b.childNodes.length - 1; 0 <= f; f--) if (b.childNodes[f].className && -1 < b.childNodes[f].className.indexOf("redips-drag")) {
                        c = !1;
                        break
                    }
                    if (!c && (null !== x && null !== z &&
    ...
    Ha = function (a, c, b) {
        ...
        if ("cell" === v) b = g[a].rows[c].cells[b], d.color[0] = b.style.backgroundColor, void 0 !== REDIPS.drag.hover.borderTd && (d.top[0] = e(b, "Top"), d.right[0] = e(b, "Right"), d.bottom[0] = e(b, "Bottom"), d.left[0] = e(b, "Left")); else {
            a = g[a].rows[c];
    ...
    ra = function (a,
                   c) {
        var b = a.cloneNode(!0), d = b.className, e, f;
    ...
    Ia = function (a, c) {
        ...
        if ("DIV" === a.nodeName) b[0](a, c); else if ("TR" === a.nodeName) b[1](a, c);
        d(0);
        d(1)
    };
    sa = function (a, c) {
    ...
    A = function (a, c) {
        var b, d, e, f = [], g = [], r, i, h, j, k = /\bredips-noautoscroll\b/i;
        ...
        for (d = b = 0; b < f.length; b++) if (Za.test(f[b].className)) "init" ===
        a || void 0 === f[b].redips ? (f[b].redips = {}, f[b].redips.container = y) : !0 === a && "number" === typeof i ? (f[b].style.opacity = "", f[b].style.filter = "") : !1 === a && "number" === typeof i && (f[b].style.opacity = i / 100, f[b].style.filter = "alpha(opacity=" + i + ")"), W(f[b], j), f[b].style.borderStyle = r, f[b].style.cursor = h, f[b].redips.enabled = j; else if ("init" === a && (e = H(f[b], "overflow"), "visible" !== e)) {
            REDIPS.event.add(f[b], "scroll", w);
            e = H(f[b], "position");
            g = B(f[b], e, !1);
            e = !k.test(f[b].className);
            O[d] = {
                div: f[b], offset: g, midstX: (g[1] +
                    g[3]) / 2, midstY: (g[0] + g[2]) / 2, autoscroll: e
            };
    ...
    Ua = function (a, c) {
        200 === a.status ? ta(c.targetTable, a.responseText) :
            REDIPS.drag.error.loadContent({type: 0, message: "AJAX error: [" + a.status + "] " + a.statusText, text: null, rowIndex: null, cellIndex: null})
    };
    ta = function (a, c) {
        var b, d, e, f, g, r, i, h;
        "string" === typeof a && (a = document.getElementById(a));
        if (void 0 === a || null === a || "TABLE" !== a.nodeName) REDIPS.drag.error.loadContent({type: 0, message: "Target table does not exist", text: null, rowIndex: null, cellIndex: null}); else {
            if (Array.isArray(c)) b = c; else try {
                b = JSON.parse(c)
            } catch (j) {
                REDIPS.drag.error.loadContent({
                    type: 0, message: j.message,
                    text: null, rowIndex: null, cellIndex: null
                });
                return
            }
            for (h = 0; h < b.length; h++) if (e = b[h][0], f = b[h][1], g = b[h][2], r = b[h][3], i = b[h][4], d = document.createElement("div"), d.id = e, d.className = ba("redips-drag " + r), d.textContent = i, void 0 === a.rows[f]) {
                if (d = REDIPS.drag.error.loadContent({type: 1, message: "Target TR [" + f + "] does not exist", text: i, rowIndex: f, cellIndex: g}), !1 === d) break
            } else if (void 0 === a.rows[f].cells[g]) {
                if (d = REDIPS.drag.error.loadContent({
                    type: 2, message: "Target TD [" + f + "," + g + "] does not exist", text: i, rowIndex: f,
                    cellIndex: g
                }), !1 === d) break
    ...
    ha = function (a, c, b) {
        ...
        if (a !== c && !("object" !==
            typeof a || "object" !== typeof c)) if (f = a.childNodes.length, "animation" === b) {
            if (0 < f) {
                b = t("TABLE", c);
                e = b.redips.idx;
        ...
        } else for (d = b = 0; b < f; b++) 1 === a.childNodes[d].nodeType && "DIV" === a.childNodes[d].nodeName ? (e = a.childNodes[d], REDIPS.drag.event.relocateBefore(e, c), c.appendChild(e), e.redips && !1 !== e.redips.enabled && W(e), REDIPS.drag.event.relocateAfter(e)) : d++
    };
    ia = function (a,
                   c) {
        var b, d = [], e;
    ...
    ua = function (a, c) {
        var b, d, e, f, g, i, h, j, E, n, l, m, p = !1, q, s;
        q = function (a, b) {
    ...
    Va = function (a) {
        ...
        for (h = 0; h < i.length; h++) for (j = 0; j < i[h].cells.length; j++) {
            ...
            f = b.colSpan || 1;
            c[a] = c[a] || [];
            for (k = 0; k < c[a].length + 1; k++) if ("undefined" === typeof c[a][k]) {
                g = k;
                break
            }
            d[a + "-" + g] = b;
    ...
    Na = function (a, c) {
        var b = (c.k1 - c.k2 * a) * (c.k1 - c.k2 * a), d, a = a + REDIPS.drag.animation.step * (4 - 3 * b) * c.direction;
        d = c.m * a + c.b;
    ...
    wa = function (a) {
        ...
        if (void 0 === a) c = h < g.length ? g[h].redips.idx :
            null === x || null === z || null === D ? g[C].redips.idx : g[x].redips.idx, b = g[C].redips.idx, c = [c, j, l, b, R, Z]; else {
    ...
    Ya = function (a) {
        var c;
        for (c = 0; c < a.childNodes.length; c++) if (1 ===
    ...
    xa = function (a, c, b) {
        ...
        if ("TR" === a.nodeName) {
            ...
            for (d = 0; d < a.length; d++) if (a[d].style.backgroundColor = b ? b : "", "empty" === c) a[d].innerHTML = ""; else for (e = 0; e < a[d].childNodes.length; e++) 1 === a[d].childNodes[e].nodeType && (a[d].childNodes[e].style.opacity = c / 100, a[d].childNodes[e].style.filter = "alpha(opacity=" + c + ")")
        } else a.style.opacity = c / 100, a.style.filter = "alpha(opacity=" +
            c + ")", a.style.backgroundColor = b ? b : ""
    };
    return {
        obj: i, objOld: m, mode: v, td: k, hover: {colorTd: "#E7AB83", colorTr: "#E7AB83"}, scroll: {enable: !0, bound: 25, speed: 20}, only: la, mark: Qa, style: {borderEnabled: "solid", borderDisabled: "dotted", opacityDisabled: "", rowEmptyColor: "white"}, trash: {className: "redips-trash", question: null, questionRow: null}, saveParamName: "p", dropMode: "multiple", multipleDrop: "bottom", clone: bb, animation: {pause: 20, step: 2, shift: !1}, shift: {mode: "horizontal1", after: "default", overflow: "bunch"}, rowDropMode: "before",
        tableSort: !0, init: function (a) {
            var c;
        ...
        }, initTables: s, enableDrag: A, clearTable: function (a) {
            var c;
            "string" === typeof a && (a = document.getElementById(a));
            if ("object" !== typeof a || "TABLE" !== a.nodeName) console.log("REDIPS.drag.clearTable: input element is not HTML table"); else {
                a = a.getElementsByTagName("DIV");
                for (c = a.length - 1; 0 <= c; c--) Za.test(a[c].className) && Ma(a[c])
            }
        }, enableTable: function (a, c) {
            var b;
            if ("object" === typeof c && "TABLE" === c.nodeName) c.redips.enabled = a; else for (b = 0; b < g.length; b++) -1 < g[b].className.indexOf(c) &&
            (g[b].redips.enabled = a)
        }, cloneObject: ra, saveContent: function (a, c) {
            var b = "", d, e, f, g, i, h, j, k, l, m = [], n = REDIPS.drag.saveParamName;
            "string" === typeof a && (a = document.getElementById(a));
            if (void 0 !== a && "object" === typeof a && "TABLE" === a.nodeName) {
                d = a.rows.length;
                for (j = 0; j < d; j++) {
                    e = a.rows[j].cells.length;
                    for (k = 0; k < e; k++) if (i = a.rows[j].cells[k], 0 < i.childNodes.length) for (l = 0; l < i.childNodes.length; l++) h = i.childNodes[l], "DIV" === h.nodeName && -1 < h.className.indexOf("redips-drag") && (f = h.className.replace(/redips-\w+/g,
            ...
            if (Array.isArray(c)) ta(a, c); else if ("string" === typeof c) try {
                JSON.parse(c), ta(a, c)
            } catch (b) {
                La(c, Ua, {targetTable: a})
            } else REDIPS.drag.error.loadContent({type: 0, message: "Invalid input parameter (URL or JSON is expected)", text: null, rowIndex: null, cellIndex: null})
        }, ajaxCall: La, relocate: ha, emptyCell: ia,
        moveObject: function (a) {
            var c = {direction: 1}, b, d, e, f, i, h;
            ...
            if (!("object" !== typeof c.obj || null === c.obj)) return c.obj.style.zIndex = 999, c.obj.redips && y !== c.obj.redips.container && (y = c.obj.redips.container, s()), h = B(c.obj), e = h[1] - h[3], f = h[2] - h[0], b = h[3], d = h[0], !0 === a.clone && "cell" === c.mode && (c.obj = ra(c.obj, !0), REDIPS.drag.event.cloned(c.obj)), void 0 === a.target ? a.target = wa() : "object" === typeof a.target && "TD" === a.target.nodeName && (a.target = wa(a.target)), c.target = a.target,
                ...
                -1), h = d, c.last = f), c.obj.redips && (c.obj.redips.animated = !0), Na(h, c), [c.obj, c.objOld]
        }, shiftCells: ua, deleteObject: Ma, getPosition: wa, rowOpacity: xa, rowEmpty: function (a, c, b) {
            a = document.getElementById(a).rows[c];
            void 0 === b && (b = REDIPS.drag.style.rowEmptyColor);
            void 0 === a.redips && (a.redips = {});
            a.redips.emptyRow = !0;
            xa(a, "empty", b)
        }, getScrollPosition: N, getStyle: H, findParent: t, findCell: Ka, event: {
            changed: function () {
            }, clicked: function () {
            }, cloned: function () {
