...
final class Version20200803083202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE wine_bottle (id INT AUTO_INCREMENT NOT NULL, box_id INT DEFAULT NULL, wine_id INT DEFAULT NULL, created_by INT DEFAULT NULL, preview_id INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, family_code VARCHAR(255) NOT NULL, comment LONGTEXT DEFAULT NULL, purchase_price DOUBLE PRECISION DEFAULT NULL, status VARCHAR(255) NOT NULL, purchase_at DATETIME DEFAULT NULL, empty_at DATETIME DEFAULT NULL, apogee_at DATETIME DEFAULT NULL, alert_at DATETIME DEFAULT NULL, alert_comment LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(128) NOT NULL, description LONGTEXT NOT NULL, popularity DOUBLE PRECISION DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_5530BC67989D9B62 (slug), INDEX IDX_5530BC67D4A8C468 (box_id), INDEX IDX_5530BC6728A2BD76 (wine_id), INDEX IDX_5530BC67DE12AB56 (created_by), UNIQUE INDEX UNIQ_5530BC67CDE46FDB (preview_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, box_id INT DEFAULT NULL, created_by INT DEFAULT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_8D93D649A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_8D93D649C05FB297 (confirmation_token), UNIQUE INDEX UNIQ_8D93D649D4A8C468 (box_id), INDEX IDX_8D93D649DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE wine_box');
